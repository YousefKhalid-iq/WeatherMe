...
function showWeatherNyc (data) {
	...
	if (idx == 0) {
		...
		<img class="main-img" src="/docs/weather app/images/main-images/nyc.jpg" alt="an image of the statue of liberty">
...
function showWeatherLondon (data) {
	...
	if (idx == 0) {
		...
		<img class="main-img" src="/docs/weather app/images/main-images/london.jpg" alt="an image of the Big Ben">
    <h2 class="main-img-text">
      LONDON, UK
      <br>
      <span id="temp-city-max">${day.temp.max + tempScale + ' /'}</span>
...
function showWeatherParis (data) {
	...
	if (idx == 0) {
		...
		<img class="main-img" src="/docs/weather app/images/main-images/paris.jpg" alt="an image of the Eiffel Tower">
    <h2 class="main-img-text">
		  PARIS, FRANCE
      <br>
      <span id="temp-city-max">${day.temp.max + tempScale + ' /'}</span>
...
function showWeatherRio (data) {
	...
	if (idx == 0) {
		...
		<img class="main-img" src="/docs/weather app/images/main-images/rio-de-janeiro.jpg" alt="an image of rio de janeiro">
    <h2 class="main-img-text">
...
function showWeatherDubai (data) {
	...
	if (idx == 0) {
		...
		<img class="main-img" src="/docs/weather app/images/main-images/dubai.jpg" alt="an image of the city Dubai">
    <h2 class="main-img-text">
		DUBAI, UAE
      <br>
      <span id="temp-city-max">${day.temp.max + tempScale + ' /'}</span>
...
function showWeatherIstanbul (data) {
	...
	if (idx == 0) {
		...
		<img class="main-img" src="/docs/weather app/images/main-images/istanbul.jpg" alt="an image of the city Istanbul">
    <h2 class="main-img-text">
		ISTANBUL, TURKEY
      <br>
      <span id="temp-city-max">${day.temp.max + tempScale + ' /'}</span>
...
function showWeatherBangkok (data) {
	...
	if (idx == 0) {
		...
		<img class="main-img" src="/docs/weather app/images/main-images/bangkok.jpg" alt="an image of the city Bangkok">
    <h2 class="main-img-text">
		  BANGKOK, THAILLAND
      <br>
      <span id="temp-city-max">${day.temp.max + tempScale + ' /'}</span>
  ...
  function searchEvent(){//add to func below
	searchBtn.addEventListener('click', function () {
		...
		.then(data => {
			...
			searchEvent.weatherSearch = weatherSearch;
		})
